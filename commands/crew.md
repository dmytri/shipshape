...
- If blocked or uncertain, stop and report the blocker.

Run the focused target and broader verification where practical. End with files changed and verification results.
