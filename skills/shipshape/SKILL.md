...
A seam MAY carry Planks for several steps. A step MAY be carried by several seams. Article 16 carries the seam obligations: at least one `@planks(...)` annotation, and behaviour only within the related step contracts.
