...
- Prefer a scantling when an independent tool discharges the constraint, such as a schema validator, a prover, or a policy engine, or when the same constraint is consumed by more than one scenario or seam.
